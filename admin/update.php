...
$sql = "UPDATE reservations SET guest_name='$guest_name', check_in_date='$check_in_date', check_out_date='$check_out_date', room_type='$room_type', num_guests=$num_guests WHERE id=$reservation_id";
